...
combina_listas([X|XS], [], [X|Resto]) :-
    combina_listas(XS, [], Resto).

combina_listas([], [Y|YS], [Y|Resto]) :-
    combina_listas([], YS, Resto).

combina_listas([X|XS], [Y|YS], [X, Y | Resto]) :-
    combina_listas(XS, YS, Resto).

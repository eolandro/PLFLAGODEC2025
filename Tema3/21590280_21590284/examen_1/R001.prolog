...
nuera(Persona1, Persona2) :-
    desciende(Hijo, Persona2),
    casados(Persona1, Hijo).

bisnietoa(Persona1, Persona2) :-
    desciende(Persona1, Padre),
    desciende(Padre, Abuelo),
    desciende(Abuelo, Persona2).

sobrinoa(Persona1, Persona2) :- 
    tioa(Persona2, Persona1).

sobrinoa(Persona1, Persona2) :-
    desciende(Persona1, Padre),
    hermanoa(Padre, Persona2).

abueloa(Persona1, Persona2) :-
    desciende(Persona2, Padre),
    desciende(Padre, Persona1).

tio_abuelo_a(Persona1, Persona2) :-
    desciende(Persona2, Padre),
    desciende(Padre, Abuelo),
    hermanoa(Persona1, Abuelo).

tio_abuelo_a(Persona1, Persona2) :-
    desciende(Persona2, Padre),
    desciende(Padre, Abuelo),
    hermanoa(Abuelo, HermanoDelAbuelo),
    casados(HermanoDelAbuelo, Persona1).

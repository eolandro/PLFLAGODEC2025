...
% Encontrar un descendiente directo o indirecto
descendiente_de(Padre, Desc) :- descendiente(Padre, Desc).
descendiente_de(Padre, Desc) :- descendiente(Padre, Hijo), descendiente_de(Hijo, Desc).

% Reúne todos los descendientes en una lista
todos_descendientes(Padre, Lista) :- findall(Desc, descendiente_de(Padre, Desc), Lista).
